...
== What's Standard Advice?

Healthcare providers typically present both delivery methods as reasonable options, though recommendations vary widely based on the provider and hospital.

*What you will usually hear:*
- "We will monitor how labor progresses and make decisions together"
- "Cesarean delivery is very safe these days"
- "Your health and the baby's safety come first"
- If you have had a previous cesarean: "A repeat cesarean is the safest option" (this is not always accurate)

*Standard screening includes:*
- Checking baby's position in late pregnancy
- Monitoring for placenta location
- Discussing any previous surgeries or health conditions
- Reviewing estimated baby size

Most providers genuinely want the best outcome for you and your baby. However, the definition of "necessary" cesarean has expanded over time, and rates vary dramatically between providers and hospitals.

#line(length: 100%)

== The Full Picture

*The fuller picture includes facts that may surprise you:*
...
*About your baby:*
- Babies born vaginally receive beneficial bacteria from their mother that help build their immune system
- Cesarean-born babies have higher rates of respiratory problems at birth
- Breastfeeding is often delayed after cesarean due to recovery from surgery
...
== When C-Sections Are Truly Necessary

Cesarean delivery can be lifesaving. The key is knowing when it is genuinely required versus when it is being recommended for other reasons.

*True emergencies requiring immediate cesarean:*
- Umbilical cord drops through the cervix (cord prolapse)
- Placenta separates from the uterine wall during labor (placental abruption)
- Uterine rupture
- Severe fetal distress requiring immediate delivery
- Uncontrolled vaginal bleeding
- Maternal cardiovascular collapse

*Planned cesareans with clear medical reasons:*
- Placenta covers the cervix (placenta previa)
- Baby is positioned sideways (transverse lie)
- Exposed fetal blood vessels across the cervical opening (vasa previa)
- Prior vertical (classical) uterine incision
- Active herpes outbreak at time of delivery
...
== Turning a Breech Baby: Options Before Cesarean
...
- The doctor applies firm pressure to your abdomen, attempting to guide baby into a somersault
- The procedure usually takes several minutes and can be uncomfortable or painful
...
Most providers perform ECV in a hospital setting where emergency cesarean is immediately available if needed.

=== Spinning Babies Techniques

*What it is:*
A set of specific exercises, movements, and positions designed to optimize pelvic alignment and encourage the baby to move into an ideal position. Developed by midwife Gail Tully, these techniques address the relationship between your pelvis, ligaments, and baby's position.

*Evidence base:*
The evidence is largely anecdotal rather than from randomized trials, but these techniques are widely used and recommended by midwives and doulas. Many birth professionals report success with these methods.

*Common techniques include:*
- *Forward-leaning inversion:* A specific position that uses gravity and gentle traction to create space in the lower uterus, potentially allowing baby to lift out of the pelvis and reposition
- *Side-lying release:* Alternating hip positions that help release pelvic tension and asymmetry
- *Rebozo sifting:* Using a long woven wrap to gently jiggle and lift the belly, helping baby shift position
- *Daily positioning:* Spending time on hands and knees, sitting on a birth ball with good posture, avoiding deep recline positions

*Cost and access:*
Many of these techniques cost nothing and can be done at home. Some people work with a Spinning Babies-trained practitioner for guidance. Videos and instructions are available at spinningbabies.com.

=== Webster Technique (Chiropractic)

*What it is:*
A specific chiropractic analysis and adjustment technique for pregnant women. The Webster Technique addresses sacral and pelvic misalignment that may restrict the uterus and make it harder for the baby to get into optimal position.
...
- Usually requires multiple sessions (weekly visits)
- Should only be performed by a chiropractor trained in the Webster Technique and experienced with pregnancy

*Safety:*
Chiropractic care during pregnancy, when performed by a trained practitioner, is considered safe. Look for a chiropractor certified by the International Chiropractic Pediatric Association (ICPA).
...
*What to expect:*
- A practitioner (or you, if trained) holds a burning moxa stick near the BL67 point (outside edge of the small toe) for 15-20 minutes per side
- The warmth should be comfortable, not burning
- Often done daily for 1-2 weeks

*Safety:*
Generally considered safe. The main risk is minor burns if the moxa stick is held too close to the skin.

=== Positioning and Movement

*What it is:*
Simple, no-cost activities and positions that use gravity and movement to encourage baby to shift position.

*Techniques to try:*
- *Hands and knees (all-fours):* Spend 10-15 minutes several times daily in this position. Gently rock the pelvis or do cat-cow stretches.
- *Pelvic tilts:* On hands and knees or standing, tilt the pelvis forward and back to create movement in the uterus
- *Swimming or pool time:* Buoyancy may give baby more freedom to move. Try gentle somersaults or handstands in the pool.
- *Breech tilt:* Lie on your back on a slanted surface (pillows under hips, head lower) for 10-15 minutes, 2-3 times daily. This is most effective before 36 weeks.
...
Many practitioners recommend combining multiple techniques rather than relying on one alone. For example:
- Daily Spinning Babies positions + weekly Webster Technique adjustments
- Moxibustion + postural techniques
- All of the above leading up to an ECV attempt at 37 weeks

=== What About Vaginal Breech Birth?
...
Breech position at 36-37 weeks does not mean automatic cesarean. You have options to try first. The success rates for turning vary, but many babies do turn with one or a combination of these techniques. Even if your baby does not turn, you will know you explored your options. And if cesarean becomes necessary, the information in the rest of this chapter will help you understand what to expect and how to support your baby's health afterward.
...
- Most severe pain
- Limited mobility
- May need help getting out of bed
- Catheter for urination
- Bowel function often disrupted

_First 1-2 weeks:_
- Pain improves but remains significant
- Incision care required
- No lifting anything heavier than your baby
- Difficulty with stairs, bending, basic movements

_6-8 weeks:_
- Most women resume normal activities
- Sexual activity typically resumes around 6 weeks
- Some experience ongoing pain or complications
- Scar continues to heal for up to 2 years
...
After your incision heals, internal scar tissue can form where tissues abnormally stick together. This becomes more common with each cesarean:
...
Each cesarean increases your risk of:
...
- We do not know if seeding prevents allergies, asthma, or other conditions
...
- "Are you familiar with the current research on vaginal seeding?"
- "Is there a research protocol at this hospital I could participate in?"
- "If I have a cesarean, what else can I do to support my baby's microbiome?"
...
== VBAC: Your Options After C-Section
...
These are excellent odds. Most women who try for VBAC deliver vaginally.
...
_May still be candidates with careful discussion:_
- Women who had induction with their previous birth
- Women with higher BMI
- Women who have never had a vaginal delivery before

_Not candidates for VBAC:_
...
- No additional surgical risks
- Your baby receives the microbiome benefits of vaginal birth
- Avoids the cumulative risks of multiple cesareans in future pregnancies
...
- "Under what circumstances would you recommend repeat cesarean versus VBAC?"

_Red flags:_
- Provider says they "allow" VBAC but seems discouraging
- Pressure toward repeat cesarean without discussing VBAC as an option
- Strict time limits on labor
- Hospital does not have 24/7 anesthesia and surgical capability

_Resources for finding support:_
- ICAN (International Cesarean Awareness Network) can help identify VBAC-supportive providers in your area: ican-online.org
- Ask local birth doulas for recommendations
- Interview multiple providers before choosing
...
_About your medical situation:_
- Do I have any absolute contraindications to vaginal birth?
- If cesarean is being recommended, what is the specific medical reason?
- Is this a true emergency, or do I have time to discuss options?

_About your provider:_
- What is their cesarean rate for low-risk, first-time mothers?
- How do they handle labor that progresses slowly?
- Are they supportive of my birth preferences?

_About your values:_
- How important is a faster recovery to me?
- Do I have other children or responsibilities that make recovery time matter more?
- How do I feel about the microbiome research?
- If I plan to have more children, how does that affect my thinking about cesarean risks?

_About your birth setting:_
- What are this hospital's cesarean rates?
- Is VBAC supported here?
- Will I have access to immediate cesarean if truly needed during labor?

*Questions to ask your provider:*
1. "What is your cesarean rate for low-risk mothers like me?"
2. "Under what circumstances would you recommend cesarean?"
3. "If labor is progressing slowly, what interventions do you typically use before recommending cesarean?"
4. "Do you support VBAC? What are your success rates?"
5. "Can you explain exactly why a cesarean is being recommended in my situation?"

#line(length: 100%)

== Our Take

Here is our direct perspective on this topic:
...
See #link(<cite-ch-vaginal-cesarean>)[all citations for this chapter] in the Citations Appendix.

#line(length: 100%)

== Key Sources

*On cesarean rates and recommendations:*
- World Health Organization Statement on Caesarean Section Rates
- European Association of Perinatal Medicine 2024 Position Statement
- "Global Increased Cesarean Section Rates" - PMC

*On vaginal seeding:*
- 2024 Systematic Review: Impact of Vaginal Seeding on Gut Microbiome - Journal of Infection
- NIH Scoping Review: Vaginal Seeding and Health Outcomes - MDPI Microbiology
- Vaginal Microbiota Transfer and Neurodevelopment - Cell Host & Microbe
- ACOG Committee Opinion on Vaginal Seeding

*On microbiome and delivery mode:*
- "Breastfeeding Restored Gut Microbiota in C-Section Infants" - BMC Pediatrics
- "Impact of Delivery Mode on Infant Gut Microbiota" - Annals of Nutrition and Metabolism

*On VBAC:*
- FIGO Good Practice Recommendations for VBAC - IJGO 2025
- StatPearls: Vaginal Birth After Cesarean Delivery
- Cleveland Clinic: VBAC Success Rates and Outcomes

*On cesarean complications:*
- "Postoperative Adhesions After Cesarean" - PMC
- "Adhesion Risk Factors After Cesarean" - AJOG
