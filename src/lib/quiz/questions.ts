...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      cons: [
        ...
        'The cascade of interventions means each intervention increases the likelihood of the next',
        'Birth centers require hospital transfer (about 12%) if complications arise - plan your backup',
        'Home births have a transfer rate of about 16% for first-time mothers',
        'Some settings may limit your pain management options',
      ],
      bottomLine: 'The setting you choose affects the care you receive. Hospitals are designed for emergencies, which means routine births often get treated with protocols optimized for efficiency and liability rather than physiological birth.',
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'unsure', label: 'I still need to think about this', birthPlanText: 'I am still deciding on my birth team.', isUnsure: true },
    ],
  },
  ...
  // =========================================================================
  {
    ...
    learnMoreData: {
      ...
      cons: [
        ...
        'Unmedicated birth can require significant preparation and continuous support',
        'Non-intrusive techniques like breathing and counter-pressure still require practice and preparation',
      ...
      bottomLine: 'Most women who achieve unmedicated birth do so through preparation and understanding of the birth process, not pain tolerance. It is a learned skill, not willpower.',
  ...
  // =========================================================================
  {
    ...
    subtitle: 'The first hour after birth is designed for bonding - how would you like to spend it?',
    order: 5,
    learnMoreData: {
      tradeoff: 'The "golden hour" is the first 60 minutes after birth when baby is naturally alert and primed for bonding and feeding. Immediate skin-to-skin contact regulates baby\'s temperature, heart rate, and breathing better than a warmer. Most routine procedures can be done while baby is on your chest.',
      pros: [
        'Baby\'s natural crawling and rooting reflexes are strongest in the first hour',
        'Skin-to-skin regulates baby\'s temperature, heart rate, breathing, and blood sugar naturally',
      ...
      bottomLine: 'You only get one golden hour. Your body is baby\'s best incubator. Most procedures can wait - this time cannot be recreated.',
      ebookChapter: 'Chapter 28: Skin-to-Skin',
    },
    options: [
      { value: 'protected', label: 'Protect it fully - immediate skin-to-skin, no interruptions', birthPlanText: 'We want the first hour after birth to be uninterrupted skin-to-skin time. Please place baby directly on my chest and delay all non-urgent procedures.', icon: 'Shield' },
  ...
  },
  {
    ...
    order: 6,
    learnMoreData: {
      tradeoff: 'Breastfeeding is biologically optimal - it provides living antibodies, immune cells, and nutrition that dynamically adapts to your baby\'s needs. Most breastfeeding difficulties are solvable with the right support. When it genuinely isn\'t possible, formula ensures your baby is nourished.',
      pros: [
        'Breast milk provides antibodies, living cells, and nutrition that adapts to baby\'s changing needs',
        'Associated with significant health benefits for both mother (reduced cancer risk) and baby (reduced infections, SIDS)',
      ...
      cons: [
        '70% of mothers experience significant breastfeeding challenges early on - support is the key variable',
        'Difficulty knowing how much baby is eating can cause anxiety with breastfeeding',
        'Formula lacks the dynamic immune properties and living cells of breast milk',
        'Breastfeeding places the physical demands entirely on the mother',
      ],
      bottomLine: 'Most breastfeeding difficulties are solvable with the right support. When it genuinely isn\'t possible, formula ensures your baby is nourished. The decision is personal, but the evidence overwhelmingly favors breastfeeding when possible.',
  ...
  // =========================================================================
  {
    ...
    learnMoreData: {
      ...
      cons: [
        'First-time mothers may feel anxious laboring at home without monitoring, but emotional sign posts can be more reliable than timing contractions',
        ...
        'You may be sent home if you arrive too early, which can be demoralizing',
      ],
      bottomLine: 'For most low-risk pregnancies, waiting until contractions are 3 minutes apart, lasting 1 minute, for 1 hour gives your body time to establish labor before hospital interventions enter the picture. Emotional sign posts - the shift from chatty to focused to inward - are often more reliable than timing alone. Trust your gut, and call your provider before leaving home.',
    },
    options: [
      { value: 'active_labor', label: 'Wait until active labor', birthPlanText: 'We plan to arrive during active labor (contractions about 3 minutes apart, with emotional sign posts of active labor).', icon: 'Clock' },
      { value: 'early', label: 'Arrive early for monitoring', birthPlanText: 'We prefer to arrive early for monitoring and support, especially given our GBS status.', icon: 'Building2' },
      { value: 'provider_guidance', label: 'Follow our provider\'s guidance', birthPlanText: 'We will call our provider before heading in and follow their guidance on timing.', icon: 'Stethoscope' },
  ...
  // =========================================================================
  {
    ...
    learnMoreData: {
      ...
      cons: [
        ...
        'Some hospital policies restrict movement as a default, so if this is important to you make sure to ask your provider',
      ],
...

  {
    ...
    learnMoreData: {
      ...
      bottomLine: 'A hep lock can give you the best of both worlds: emergency access without being tethered. Most hospitals will accommodate this request. You have the right to refuse an IV.',
    },
    options: [
  ...
  },
  {
    ...
    order: 10.2,
    learnMoreData: {
      tradeoff: 'Labor is a marathon - your body needs fuel, particularly for lower-risk mothers. Many hospitals still restrict food "in case of surgery," but current evidence supports eating and drinking for low-risk labors.',
      pros: [
      ...
      cons: [
        'You may not feel up to eating during active labor, especially during transition',
  ...
  },
  {
    ...
    options: [
      { value: 'dim_quiet', label: 'Dim lighting and quiet', birthPlanText: 'We prefer dim lighting and a quiet environment, and minimal interruptions / check-ins from hospital staff.', icon: 'Moon' },
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      cons: [
        ...
        'Antibiotics increase the risk of mastitis in breastfeeding mothers',
        'The standard for untested mothers is no antibiotics - testing positive doesn\'t mean infection',
        'African American women, mothers under 20, and those with GBS in urine have higher risk factors',
      ],
      bottomLine: 'If you are GBS positive, the antibiotics significantly reduce a small but serious risk. The microbiome impact is real and can last up to a year - breastfeeding helps restore it. Weigh the risk carefully with your provider.',
  ...
  },
  {
    ...
    order: 10.5,
    learnMoreData: {
      tradeoff: 'The standard "on your back, feet in stirrups" position works against gravity and narrows the pelvis, making tearing more likely. Upright and side-lying positions open the pelvis by up to 30% and let gravity help.',
      pros: [
  ...
  },
  {
    ...
    order: 12,
    learnMoreData: {
      tradeoff: 'A single injection provides near-complete protection against VKDB (a rare but potentially fatal bleeding disorder). The oral alternative is standard in several countries but requires multiple doses over weeks, and provider skepticism stems primarily from compliance concerns.',
      pros: [
      ...
      cons: [
        ...
        'Oral alternative is standard in countries like the Netherlands and requires 3 doses over 6 weeks (about 80% effective)',
        'If circumcising, the injection is strongly recommended since the procedure involves bleeding risk',
      ],
    ...
    options: [
      ...
      { value: 'oral', label: 'Prefer oral Vitamin K', birthPlanText: 'We prefer oral Vitamin K administration over the injection.', icon: 'Droplet' },
      { value: 'oral_own', label: 'Oral - we will bring our own', birthPlanText: 'We prefer oral Vitamin K and will bring our own supply.', icon: 'Package' },
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      pros: [
        ...
        'Required by law in many states as a public health measure, though in most places parents can still opt out',
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      cons: [
        'Significant pain at a fragile stage in life, even with anesthesia (cortisol spikes 3-4x)',
        ...
        'An irreversible procedure that cannot be undone - removes the choice from the child to make this decision about his own body later',
        'An estimated 100 baby boys die per year in the US from circumcision complications',
      ],
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      bottomLine: 'This is one of the most universally recommended newborn procedures. The discomfort of a heel prick is negligible compared to the conditions it can catch. Breastfeeding during the test helps.',
    },
    options: [
...

  {
    ...
    options: [
      { value: '1min', label: 'Wait at least 1 minute', birthPlanText: 'Please wait at least 90 seconds before clamping the cord.', icon: 'Clock' },
      { value: '3-5min', label: 'Wait 3-5 minutes', birthPlanText: 'Please delay cord clamping for at least 5 minutes.', icon: 'Timer' },
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      cons: [
        'Cord blood banking will necessitate more immediate cord clamping, reducing those benefits',
  ...
  },
  {
    ...
    learnMoreData: {
      ...
      cons: [
        ...
        'Set expectations early for how long visits will last - exhaustion sneaks up fast',
        'Consider designating your partner as the gatekeeper for visitor scheduling',
      ],
      bottomLine: 'You will never get these first days back. Protect them fiercely. Relatives who are overbearing can be a significant source of stress during recovery. Real friends will understand, and family will adjust.',
    },
    options: [
...

  {
    ...
    order: 19.1,
    learnMoreData: {
      tradeoff: 'Standard stays are 24-48 hours for vaginal births and 48-96 hours for C-sections (birth centers are often 4-12 hours). Length of stay is often dependent on hospital policy. Some families want to leave early to recover at home; others want the full support period.',
      pros: [
        ...
        'First-time parents can learn essential skills like breastfeeding and diapering with professional support nearby',
      ],
      cons: [
        'Hospital policies may discourage leaving early, and leaving against medical advice (AMA) can affect insurance',
        'First-time parents may feel overwhelmed at home without nurse support',
        'Insurance typically covers the standard stay, though leaving early may save money depending on your situation',
        'Pediatrician follow-up within 48 hours is especially important with early discharge',
      ],
      bottomLine: 'There is no medal for leaving early. Use the hospital\'s resources while you have them, especially lactation support. Some families may feel more comfortable in their own space. Discuss your preferences at a prenatal appointment so there are no surprises.',
    },
    options: [
  ...
  // =========================================================================
  {
    ...
    options: [
      ...
      { value: 'keep', label: 'Keep for other reasons', birthPlanText: 'We would like to keep the placenta.', icon: 'Package' },
  ...
  },
  {
    ...
    deferredFor: 'csection',
    learnMoreData: {
      tradeoff: 'Delayed cord clamping during a C-section is safe and increasingly supported by research. Some surgeons push back on it, but the infection risk is minuscule and the benefits to baby are significant. It gives baby up to 30% more blood volume.',
      pros: [
      ...
      cons: [
        ...
        'Delay is typically shorter than in vaginal birth, though you can ask for longer time',
    ...
    options: [
      ...
      { value: 'brief_delay', label: 'Brief delay (at least 90 seconds)', birthPlanText: 'During a C-section, please delay cord clamping for at least 90 seconds.', icon: 'Clock' },
